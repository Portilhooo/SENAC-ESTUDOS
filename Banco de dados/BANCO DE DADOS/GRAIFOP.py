...
tk.Label(frame_dados, text="ID").grid(row=0, column=0)
txt_id=tk.Entry(frame_dados)
txt_id.grid(row=0, column=1)

tk.Label(frame_dados,text="Nome").grid(row=1, column=0)
txt_nome=tk.Entry(frame_dados)
txt_nome.grid(row= 1, column=1)

tk.Label(frame_dados,text="Preço").grid(row=2, column=0)
